    ...
    >
      ...
      >
        ...
        >
          ...
          {!isSelectMode && (
            <div
              className={`absolute top-0 ${isSent ? "-left-20" : "-right-20"} hidden group-hover:flex items-center gap-1 p-1 bg-card border border-border/50 shadow-md rounded-lg animate-in fade-in z-10 w-max`}
            >
              ...
              <div className="relative" ref={contextMenuRef}>
                ...
                {isContextMenuOpen && (
                  <div
                    className={`absolute top-full mt-2 w-48 bg-card border border-border/80 rounded-xl shadow-xl py-2 z-50 animate-in fade-in zoom-in-95 ${isSent ? "right-0" : "left-0"}`}
                  >
