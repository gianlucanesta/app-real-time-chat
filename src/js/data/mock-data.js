    ...
    messages: [
      {
        id: "m1",
        from: "them",
        text: "Hey, are you free to jump on a call later?",
        time: "Yesterday 4:10 PM",
      },
      {
        id: "m2",
        from: "me",
        text: "Not today, swamped with the sprint review.",
        time: "Yesterday 4:15 PM",
      },
      {
        id: "m3",
        from: "them",
        text: "Let's reschedule for tomorrow then!",
    ...
    messages: [
      {
        id: "m1",
        from: "them",
        text: "Wait, did you see the update to the design system?",
    ...
    messages: [
      {
        id: "m1",
        from: "them",
        text: "The presentation looks solid, Gianluca! Great job on the slides.",
        time: "Mon 10:00 AM",
      },
      {
        id: "m2",
        from: "me",
        text: "Thanks Sarah! Really appreciate it.",
        time: "Mon 10:05 AM",
      },
    ],
  },
...
export function seedDemoData() {
  ...
  localStorage.setItem(
    STORAGE_KEY,
    JSON.stringify({ _v: SCHEMA_V, users: [demoUser] }),
  );
}
